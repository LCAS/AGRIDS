...
def create_block_entity(block_id, vineyard_id, user_defined_id, name, row_spacing_m, variety, anchor_post_distance, under_vine_width, vine_spacing_m, date_start, date_end, geom_coordinates):
