...
while True:
    ...
    ORION_LIST_ENTITIES_ENDPOINT = f'{ORION_ENDPOINT_BASE}?type=VineRow&limit={limit}&offset={offset}'
    ...
    if response.status_code == 200:
        ...
        for vine_row in vine_rows:
            ...
            update_response = requests.post(ORION_ENDPOINT, data=updated_vine_json, headers=headers)
